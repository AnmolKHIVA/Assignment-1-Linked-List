...
int main(){
	...
	cout<<"Enter total Number Of Family Members:";cin>>no_of_family_mem;
    ...
    cout<<endl;
    //Family details
    cout<<"The required doubly Linked list with my family members is shown below:"<<endl;
    cout<<endl;
...
/*
QUESTION 2
Try to find a way to link the family members' doubly-linked list based on their relationship.
ANSWER
We can sort the doubly linked list according to age in decending order so that we will get a doubly linked list in which older generation people will be close to head in double linked list and new generation people will be close to tail in doubly linked list.
*/